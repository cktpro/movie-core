...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        // spatie/laravel-permission 6.x: PermissionRegistrar::$pivotPermission/$pivotRole đã bỏ
        // (từng là static property ở bản cũ) -> lấy trực tiếp từ config như migration gốc hiện tại.
